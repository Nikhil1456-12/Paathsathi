...
class HomeScreen extends ConsumerWidget {
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  IconButton(
                    ...
                    icon: const Icon(Icons.hub_rounded, color: Color(0xFFF97316)),
                    tooltip: 'Fog Dashboard',
                  ),
                  IconButton(onPressed: () {}, icon: const Icon(Icons.notifications_outlined, color: Color(0xFF4B5563))),
                ]),
              ),
              ...
              Container(
                ...
                child: Column(children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: _saffron,
                          boxShadow: [
                            BoxShadow(color: _saffron.withValues(alpha: 0.5), blurRadius: 24, spreadRadius: 4),
                          ],
                        ),
                  ...
                  Text(AppStrings.tapToSpeak(lang),
                    style: GoogleFonts.outfit(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1.0)),
                  ...
                  Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      const Icon(Icons.wifi_off, color: Colors.white70, size: 13),
              ...
              Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(children: [
                    ...
                    _chip(AppStrings.myJourney(lang), () => context.go('/journey')),
                    const SizedBox(width: 8),
                    _chip(AppStrings.emergency(lang), () => context.push('/emergency')),
                  ]),
                ),
              ),
              ...
              Padding(
                ...
                child: Text('Quick Access',
                  style: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.w700, color: const Color(0xFF111827))),
              ),
              const SizedBox(height: 12),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: GridView.count(
                  ...
                  children: [
                    _gridCard(context, Icons.directions_bus_outlined, AppStrings.transport(lang), '/transport'),
                    _gridCard(context, Icons.map_outlined, AppStrings.navigate(lang), '/nav'),
                    _gridCard(context, Icons.holiday_village_outlined, AppStrings.myStay(lang), '/accommodation'),
                    _gridCard(context, Icons.calendar_today_outlined, AppStrings.itinerary(lang), '/itinerary'),
                    _gridCard(context, Icons.download_for_offline_rounded, 'Offline City Maps 🗺', '/city-map-picker'),
                    _gridCard(context, Icons.emergency_rounded, AppStrings.emergency(lang), '/emergency'),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.biotech_outlined, color: _saffron, size: 22),
                      const SizedBox(width: 12),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('🧪 STT + TTS Test Lab',
                          style: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w700, color: _saffron)),
                        Text('Test 20 speech phrases across all languages',
                          style: GoogleFonts.outfit(fontSize: 11, color: const Color(0xFF92400E))),
                      ])),
                      const Icon(Icons.arrow_forward_ios, size: 14, color: _saffron),
                    ]),
                  ),
                ),
              ),
  ...
  Widget _chip(String label, VoidCallback onTap) => GestureDetector(
    ...
    child: Container(
      ...
      child: Text(label, style: GoogleFonts.outfit(fontSize: 12, color: const Color(0xFF111827))),
    ),
  );

  Widget _gridCard(BuildContext ctx, IconData icon, String label, String route) => GestureDetector(
    ...
    child: Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(label,
          style: GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF111827)),
